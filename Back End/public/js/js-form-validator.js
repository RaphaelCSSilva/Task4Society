	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    en: {
				...
				username: {
		            empty: 'Insira o seu username por favor',
		            incorrect: 'Username incorreto'
		        },
		        name: {
		            empty: 'Insira o seu nome por favor',
		        ...
		        phone: {
		            empty: 'Insira o seu número de telemóvel por favor',
		            incorrect: 'Número de telemóvel incorreto'
		        },
		        email: {
		            empty: 'Insira o seu email por favor',
		            incorrect: 'Email incorreto'
		        },
		        length: {
		            empty: 'Insira, por favor, um mínimo de {0} caracteres e um máximo de {1}',
		            incorrect: 'Incorreto. Insira um minimo de {0} caracteres e um maximo de {1}'
		        },
		        minlength: {
		            empty: 'Insira, por favor, um mínimo de {0} caracteres',
		            incorrect: 'Inseriu menos do que {0} caracteres'
		        },
		        maxlength: {
		            empty: 'Insira, por favor, um máximo de {0} caracteres',
		            incorrect: 'Inseriu mais do que {0} caracteres'
		        },
		        maxfilesize: {
